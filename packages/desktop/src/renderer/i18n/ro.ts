export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune Blank",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} Blank a fost descărcată. Vrei să o instalezi și să repornești?",
