export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Blank",
  ...
  "desktop.menu.ariaLabel": "Blank meni",
  ...
  "desktop.recovery.loadFailed": "Blank se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Blank-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Blank ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Blank-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Blank nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Blank-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Blank",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Blank-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Blank-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Blank-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Blank server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Blank...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Blank u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Blank...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Blank u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Blank u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Blank",
  "wsl.onboarding.opencodeReadyIn": "Blank je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Blank je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Blank u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Blank",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Blank mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Blank nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Blank.",
  ...
  "help.tabs.introduction": "Blank Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Blank-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Blank timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Blank još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Blank uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Blank server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Blank-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Blank izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Blank prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Blank-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Blank pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Blank-a.",
