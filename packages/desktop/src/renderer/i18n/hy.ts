export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք Blank-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "Blank-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
