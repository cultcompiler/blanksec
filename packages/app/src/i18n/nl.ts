export const dict = {
  ...
  "desktop.menu.documentation": "Blank-documentatie",
  ...
  "desktop.recovery.loadFailed": "Blank kan niet worden geladen",
  "desktop.recovery.terminated": "Het Blank-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Blank reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Blank is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Blank is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Blank-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Blank",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Blank te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Blank te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Blank te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Blank-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Blank controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Blank controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Blank bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Blank bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Blank bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Blank bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Blank is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Blank is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Blank in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Blank",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Blank een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Blank kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Blank opnieuw.",
  ...
  "help.tabs.introduction": "Blank Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Blank ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Blank-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Blank ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Blank bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Blank-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Blank",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Blank eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Blank het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Blank aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Blank wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Blank is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Blank.",
