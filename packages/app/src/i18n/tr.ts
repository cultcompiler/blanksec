...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Blank yüklenemedi",
  "desktop.recovery.terminated": "Blank penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Blank yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Blank kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Blank, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Blank güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Blank tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Blank'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Blank'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Blank'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Blank sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Blank kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Blank kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Blank güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Blank güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Blank'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Blank'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Blank hazır.",
  "wsl.onboarding.opencodeReady": "Blank hazır.",
  "wsl.onboarding.installOpencodeIn": "Blank'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Blank'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Blank'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Blank bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Blank'u tekrar açın.",
  ...
  "help.tabs.introduction": "Blank Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Blank'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Blank ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Blank henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Blank ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Blank Masaüstü",
  ...
  "settings.desktop.wsl.description": "Blank sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Blank'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Blank'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Blank'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Blank'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Blank başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Blank'un en son sürümünü kullanıyorsunuz.",
