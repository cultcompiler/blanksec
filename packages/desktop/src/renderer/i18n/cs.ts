export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi Blank",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace Blank. Chcete ji nainstalovat a aplikaci znovu spustit?",
