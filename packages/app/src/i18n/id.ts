export const dict = {
  ...
  "desktop.recovery.loadFailed": "Blank gagal dimuat",
  "desktop.recovery.terminated": "Jendela Blank berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Blank tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Blank gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Blank belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Blank selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Blank",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Blank.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Blank.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Blank.",
  ...
  "dialog.server.description": "Ganti server Blank mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Blank...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Blank di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Blank...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Blank di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Blank di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Blank",
  "wsl.onboarding.opencodeReadyIn": "Blank siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Blank siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Blank di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Blank",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Blank dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Blank tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Blank.",
  ...
  "help.tabs.introduction": "Blank Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Blank ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Blank",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Blank belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Blank menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Blank di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Blank",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Blank di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Blank mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Blank diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Blank.",
