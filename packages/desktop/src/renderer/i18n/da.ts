export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Blank",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Blank er blevet downloadet. Vil du installere den og genstarte?",
