...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Blank",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Blank.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Blank Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Blank.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Blank.",
  ...
  "dialog.server.description": "Switch which Blank server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Blank...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Blank in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Blank...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Blank in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Blank in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Blank",
  "wsl.onboarding.opencodeReadyIn": "Blank is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Blank is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Blank in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Blank",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Blank can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Blank could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Blank.",
  ...
  "help.tabs.introduction": "Blank Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Blank ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Blank team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Blank does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Blank includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Blank server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Blank",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Blank looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Blank follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Blank is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Blank launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Blank.",
