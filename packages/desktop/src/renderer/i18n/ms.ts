export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini Blank",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} Blank telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
