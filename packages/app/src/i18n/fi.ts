export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Blankn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Blankssa.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Blankssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Blankssa.",
  ...
  "dialog.server.description": "Vaihda Blank-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Blanka...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Blanka kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Blanka...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Blanka kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Blank jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Blank",
  "wsl.onboarding.opencodeReadyIn": "Blank on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Blank on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Blank jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Blank",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blanka ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Blank voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Blank ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Blank uudelleen.",
  ...
  "toast.update.description": "Blankn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Blank-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Blank ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Blank sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Blank-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Blankn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Blank näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Blank järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Blankn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Blank käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Blankn uusinta versiota.",
  ...
  "desktop.menu.documentation": "Blank-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Blank-valikko",
  ...
  "desktop.recovery.loadFailed": "Blankn lataaminen epäonnistui",
  "desktop.recovery.terminated": "Blank-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Blank ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Blankn asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Blanka ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Blankn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Blank Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
