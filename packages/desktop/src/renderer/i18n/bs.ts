export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Blank-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Blank-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
