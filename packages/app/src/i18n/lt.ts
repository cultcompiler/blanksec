...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Blank įkelti nepavyko",
  "Blank langas netikėtai užsidarė",
  "Blank neatsako",
  ...
  "Blank įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Blank neįdiegtas distributyve {{distro}}",
  "Blank naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Blank modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Blank.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Blank.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Blank.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Blank serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Blank...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Blank {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Blank...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Blank {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Blank {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Blank",
  "wsl.onboarding.opencodeReadyIn": "Blank yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Blank yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Blank į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Blank",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Blank galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Blank nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Blank.",
  ...
  "help.tabs.introduction": "Blank Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Blank ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Blank komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Blank dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Blank apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Blank darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Blank serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Blank ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Blank atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Blank seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Blank temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Blank",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Blank versiją.",
