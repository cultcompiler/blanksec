...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Blank",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Blank zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Blank zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Blank zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Blank-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "Blank",
  ...
  "wsl.onboarding.checkingOpencode": "Blank wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Blank in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Blank wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Blank in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Blank in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Blank aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Blank ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Blank ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Blank in {{distro}}.",
  "wsl.onboarding.installOpencode": "Blank installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Blank einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Blank konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Blank erneut.",
  ...
  "toast.update.description": "Eine neue Version von Blank ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Blank-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Blank unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Blank mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Blank enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Blank Desktop",
  ...
  "settings.desktop.wsl.description": "Blank-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Blank ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Blank auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Blank dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Blank anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Blank automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Blank ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Blank wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Blank konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Blank-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Blank reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Blank-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Blank ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Blank-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Blank Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
