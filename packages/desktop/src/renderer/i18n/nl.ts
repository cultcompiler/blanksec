export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Blank",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Blank is gedownload. Wil je deze installeren en Blank opnieuw starten?",
