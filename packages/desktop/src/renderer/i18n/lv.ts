export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Blank versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Blank versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
