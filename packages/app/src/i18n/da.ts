export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Blank",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Blank.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Blank.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Blank.",
  ...
  "dialog.server.description": "Skift hvilken Blank-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Blank...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Blank i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Blank...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Blank i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Blank i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Blank",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Blank kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Blank kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Blank igen.",
  ...
  "toast.update.description": "En ny version af Blank ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Blank-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Blank understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Blank inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Blank-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Blank",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Blank ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Blank skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Blanks tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Blank starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Blank.",
  ...
  "desktop.recovery.loadFailed": "Blank kunne ikke indlæses",
  "desktop.recovery.terminated": "Blank-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Blank mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Blank er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Blank er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Blank Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
