export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru Blank",
  ...
  "desktop.updater.downloaded.prompt":
    "Blank versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
