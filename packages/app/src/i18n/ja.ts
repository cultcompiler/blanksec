export const dict = {
  ...
  "desktop.recovery.loadFailed": "Blankを読み込めませんでした",
  "desktop.recovery.terminated": "Blankのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Blankが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Blankのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはBlankがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Blankのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "Blankが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Blankで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してBlankで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Blankで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するBlankサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Blankを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のBlankを確認中...",
  "wsl.onboarding.updatingOpencode": "Blankを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のBlankを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のBlankを更新してください。",
  "wsl.onboarding.updateOpencode": "Blankを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のBlankの準備ができました。",
  "wsl.onboarding.opencodeReady": "Blankの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にBlankをインストールしてください。",
  "wsl.onboarding.installOpencode": "Blankをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blankがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "BlankでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Blankをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Blank Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Blankの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをBlankチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: BlankはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Blankには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でBlankサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Blankの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのBlankの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Blankがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Blankのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Blank の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Blank は最新バージョンです。",
