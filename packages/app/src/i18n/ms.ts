export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Blank",
  ...
  "desktop.recovery.loadFailed": "Blank gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Blank ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Blank tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Blank gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Blank tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Blank selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Blank",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Blank.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Blank.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Blank.",
  ...
  "dialog.server.description": "Tukar pelayan Blank yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Blank...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Blank dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Blank...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Blank dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Blank dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Blank",
  "wsl.onboarding.opencodeReadyIn": "Blank sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Blank sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Blank dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Blank",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Blank boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Blank tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Blank.",
  ...
  "help.tabs.introduction": "Blank Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Blank ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Blank",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Blank belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Blank merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Blank dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Blank",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Blank pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Blank mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Blank.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Blank dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Blank.",
