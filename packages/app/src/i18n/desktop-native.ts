...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Blank failed to load",
  "desktop.recovery.terminated": "Blank window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Blank is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Blank installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Blank is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Blank update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
