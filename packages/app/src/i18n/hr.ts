...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Blank se nije uspio učitati",
  "Prozor aplikacije Blank neočekivano je zatvoren",
  "Blank ne reagira",
  ...
  "Instalacija aplikacije Blank nije uspjela",
  ...
  "Blank nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Blank je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Blank",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Blank.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Blank.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Blank.",
  ...
  "dialog.server.description": "Promijenite na koji se Blank poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Blank u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Blank...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Blank u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Blank u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Blank",
  "wsl.onboarding.opencodeReadyIn": "Blank je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Blank je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Blank u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Blank",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Blank može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Blank nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Blank.",
  ...
  "help.tabs.introduction": "Radna površina Blank sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Blank ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Blank timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Blank još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Blank uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Blank Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Blank poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Blank",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Blank izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Blank slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Blank tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Blank pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Blank.",
