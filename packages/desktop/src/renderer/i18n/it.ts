export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di Blank",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di Blank è stata scaricata. Vuoi installarla e riavviare l'app?",
