export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Blank",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Blank. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
