export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Blank",
  "desktop.recovery.terminated": "توقفت نافذة Blank بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Blank لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Blank",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Blank غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Blank، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Blank",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Blank.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك Blank Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Blank.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Blank.",
  ...
  "dialog.server.description": "تبديل خادم Blank الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Blank...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Blank في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Blank...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Blank في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Blank في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Blank",
  "wsl.onboarding.opencodeReadyIn": "Blank جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Blank جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Blank في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Blank",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Blank من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Blank التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Blank.",
  ...
  "help.tabs.introduction": "أصبح Blank Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Blank ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Blank",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Blank لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Blank نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Blank داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Blank",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Blank على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Blank يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Blank.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Blank",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Blank.",
