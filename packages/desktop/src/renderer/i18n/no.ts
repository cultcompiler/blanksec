export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Blank",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Blank er lastet ned. Vil du installere den og starte på nytt?",
