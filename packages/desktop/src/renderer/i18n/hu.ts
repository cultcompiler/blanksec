export const dict = {
  ...
  "desktop.updater.none.message": "Már az Blank legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Blank {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
