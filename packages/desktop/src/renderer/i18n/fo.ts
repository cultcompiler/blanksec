export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av Blank.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av Blank er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
