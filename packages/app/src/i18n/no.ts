...
export const dict = {
  ...
  "desktop.menu.documentation": "Blank-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Blank-meny",
  ...
  "desktop.recovery.loadFailed": "Blank kunne ikke lastes inn",
  "desktop.recovery.terminated": "Blank-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Blank svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Blank mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Blank er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Blank er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Blank",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Blank.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Blank.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Blank.",
  ...
  "dialog.server.description": "Bytt hvilken Blank-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Blank ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Blank-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Blank ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Blank inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Blank-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Blank",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Blank ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Blank skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Blank.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Blank starter",
  ...
  "settings.updates.toast.latest.title": "Blank er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Blank.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Blank...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Blank i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Blank...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Blank i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Blank i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Blank",
  "wsl.onboarding.opencodeReadyIn": "Blank er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Blank er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Blank i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Blank kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Blank kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Blank på nytt.",
  ...
  "help.tabs.introduction": "Blank Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
