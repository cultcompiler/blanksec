export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Blank",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Blank wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
