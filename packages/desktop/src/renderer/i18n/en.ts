export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Blank",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Blank has been downloaded, would you like to install it and relaunch?",
