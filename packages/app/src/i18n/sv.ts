export const dict = {
  ...
  "desktop.recovery.loadFailed": "Blank kunde inte läsas in",
  "desktop.recovery.terminated": "Blank-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Blank svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Blank misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Blank är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Blank-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Blank",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Blank.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Blank.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Blank.",
  ...
  "dialog.server.description": "Växla vilken Blank-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Blank...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Blank i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Blank...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Blank i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Blank i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Blank",
  "wsl.onboarding.opencodeReadyIn": "Blank är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Blank är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Blank i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Blank",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Blank kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Blank kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Blank igen.",
  ...
  "help.tabs.introduction": "Blank Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Blank ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Blank-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Blank stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Blank innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Blank-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Blank",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Blank ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Blank följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Blanks tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Blank startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Blank.",
