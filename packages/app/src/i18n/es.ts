export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Blank",
  ...
  "desktop.menu.ariaLabel": "Menú de Blank",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Blank",
  "desktop.recovery.terminated": "La ventana de Blank se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Blank no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Blank",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Blank no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Blank finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Blank",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Blank.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Blank.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Blank.",
  ...
  "dialog.server.description": "Cambiar el servidor de Blank al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Blank...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Blank en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Blank...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Blank en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Blank en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Blank",
  "wsl.onboarding.opencodeReadyIn": "Blank está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Blank está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Blank en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Blank",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Blank pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Blank no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Blank.",
  ...
  "help.tabs.introduction": "Blank Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Blank ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Blank",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Blank aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Blank incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Blank dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Blank",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Blank en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Blank sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Blank.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Blank",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Blank.",
