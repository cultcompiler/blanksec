export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Blank",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Blank har laddats ned. Vill du installera den och starta om programmet?",
