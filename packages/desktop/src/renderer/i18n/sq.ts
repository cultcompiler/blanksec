export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të Blank",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i Blank është shkarkuar, dëshironi ta instaloni dhe rinisni?",
