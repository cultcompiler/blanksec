export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Blank",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Blank",
  "desktop.recovery.terminated": "La fenêtre Blank s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Blank ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Blank",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Blank n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Blank est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Blank",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Blank.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Blank.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Blank.",
  ...
  "dialog.server.description": "Changez le serveur Blank auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Blank...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Blank dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Blank...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Blank dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Blank dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Blank",
  "wsl.onboarding.opencodeReadyIn": "Blank est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Blank est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Blank dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Blank",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Blank puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Blank n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Blank.",
  ...
  "help.tabs.introduction": "Blank Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Blank ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Blank",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Blank ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Blank inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Blank dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Blank",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Blank sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Blank suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Blank.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Blank",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Blank.",
