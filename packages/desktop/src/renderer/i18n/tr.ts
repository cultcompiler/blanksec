export const dict = {
  ...
  "desktop.updater.none.message": "Blank'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Blank'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
