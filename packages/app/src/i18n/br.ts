export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Blank",
  ...
  "desktop.menu.ariaLabel": "Menu do Blank",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Blank",
  "desktop.recovery.terminated": "A janela do Blank foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Blank não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Blank",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Blank não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Blank foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Blank",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Blank.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Blank.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Blank.",
  ...
  "dialog.server.description": "Trocar para qual servidor Blank este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Blank...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Blank em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Blank...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Blank em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Blank em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Blank",
  "wsl.onboarding.opencodeReadyIn": "O Blank está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Blank está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Blank em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Blank",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Blank possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Blank não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Blank novamente.",
  ...
  "help.tabs.introduction": "Agora, o Blank Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Blank ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Blank",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Blank ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Blank inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Blank dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Blank",
  ...
  "settings.general.row.appearance.description": "Personalize como o Blank aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Blank segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Blank é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Blank iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Blank.",
