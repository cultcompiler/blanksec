export const dict = {
  ...
  "desktop.recovery.loadFailed": "Blank laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Blank aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Blank ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Blank installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Blank pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Blank värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Blank",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Blank'is.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blank Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Blank.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Blank.",
  ...
  "dialog.server.description": "Lülitage, millise Blank serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Blank kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Blank kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Blank värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Blank värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Blank jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Blank",
  "wsl.onboarding.opencodeReadyIn": "Blank on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Blank on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Blank asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Blank",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Blank pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Blank saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Blank ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Blank.",
  ...
  "help.tabs.introduction": "Blank Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Blank ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Blank meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Blank ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Blank sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Blank Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Blank server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Blank kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Blank teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Blank järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Blank on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Blank käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Blank uusimat versiooni.",
