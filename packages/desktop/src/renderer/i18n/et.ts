export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Blank uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Blank'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
